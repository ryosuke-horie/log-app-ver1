        ...
        return offsetParent &&
          ...
          : offsetParent ||
              (function getContainingBlock(element) {
                for (
                  var isFirefox = navigator.userAgent
                      .toLowerCase()
                      .includes('firefox'),
              ...
              fn: function preventOverflow(_ref) {
                ...
                if (popperOffsets) {
                  if (checkMainAxis || checkAltAxis) {
                    var mainSide = 'y' === mainAxis ? enums.m : enums.f,
                    ...
                    if (checkAltAxis) {
                      var _mainSide = 'x' === mainAxis ? enums.m : enums.f,
            ...
            },
            {
              ...
              fn: function arrow(_ref) {
                ...
                if (arrowElement && popperOffsets) {
                  var paddingObject =
                      state.modifiersData[name + '#persistent'].padding,
